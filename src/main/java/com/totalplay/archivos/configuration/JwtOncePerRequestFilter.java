package com.totalplay.archivos.configuration;
...
import com.totalplay.archivos.common.MessageException;
import com.totalplay.archivos.jwt.BuildJwt;
import com.totalplay.archivos.model.ErrorModel;
...
public class JwtOncePerRequestFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if( request.getPathInfo().contains("/file/files/") ) {
